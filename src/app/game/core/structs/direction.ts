...
export class Direction {
  ...
  constructor() {
    $(document).on('command:up', this.lift.bind(this));
    $(document).on('command:down', this.lower.bind(this));
    $(document).on('command:left', this.toLeft.bind(this));
    $(document).on('command:right', this.toRight.bind(this));
  }
